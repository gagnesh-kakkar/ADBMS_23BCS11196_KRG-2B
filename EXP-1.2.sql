...
--QUESTION 1: MEDIUM
CREATE TABLE EMPLOYEE(EMPID INT IDENTITY(1, 1), Ename VARCHAR(MAX), Department VARCHAR(MAX), ManagerID INT)
...
SELECT E1.Ename AS [EMPLYEE NAME], E2.Ename AS [MANAGER NAME],
